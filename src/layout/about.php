...
<main>
    <div class="welcome about">
        <section class="welcome__section about">
            ...
            <p class="welcome__paragraph about">Somos un taller automotriz dedicado a brindar soluciones efectivas y
                ...
                servicio excepcional, utilizando tecnología de vanguardia y los mejores recursos para garantizar
                resultados excelentes en cada reparación y mantenimiento que realizamos.</p>
        </section>
    ...
    <div class="values">
        <article class="values__box active">
            <figure class="values__icon"><img class="values__icon-img" src="/public/assets/values_icons/Compromiso.svg"
                    alt=""></figure>
            <h2 class="values__box-title">Compromiso</h2>
        ...
        <article class="values__box">
            <figure class="values__icon"><img class="values__icon-img" src="/public/assets/values_icons/Honestidad.svg"
                    alt=""></figure>
            <h2 class="values__box-title">Honestidad</h2>
            <p class="values__box-paragraph">La honestidad es uno de nuestros valores fundamentales. Nos aseguramos de
        ...
        <article class="values__box">
            ...
            <h2 class="values__box-title">responsabilidad</h2>
            <p class="values__box-paragraph">Tanto con nuestros clientes como con nosotros mismos, la responsabilidad es
                pilar fundamental en nuestro trabajo para el correcto desempeño de todas nuestras tareas.</p>
        </article>
    </div>
    <div class="mision">
    ...
    <div class="mision vision">
        <h1 class="mision__title">Visión</h1>
        <p class="mision__paragraph">Nuestra visión es ser el taller automotriz líder en calidad y servicio, brindando
    ...
    <div class="callToAction">
        <div class="callToAction__box">
            <h1 class="callToAction__title">Sabemos que buscas en quienes poder confiar y estamos aquí para demostrar que
                somos lo que necesitas, conoce
                más acerca de nuestros servicios y lo que podemos hacer por tí</h1>
        </div>
        <div class="callToAction__btn">
            <a href="/src/layout/services.php" class="callToAction__btn-link"><img class="callToAction__btn-img" src="/public/assets/icons/reshot-icon-right-long-arrow-2MGLKCZ874-17dc7.svg" alt=""></a>
        </div>
    </div>
</main>
